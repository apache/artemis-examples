...
This example shows you how to make an XA heuristic decision through the Apache Artemis Management Interface.
...
This example uses JMX to manipulate transactions in a Apache Artemis Server. For details on JMX facilities with Apache Artemis, please look at the JMX Example.