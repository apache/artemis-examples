...
Apache Artemis can be configured to accept requests from any AMQP client that supports the 1.0 version of the protocol. This example shows a simply proton ruby client that sends and receives messages.
...
To configure Apache Artemis to accept AMQP client connections you need to add an Acceptor like so:
